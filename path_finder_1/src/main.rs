...
fn path_finder(maze: &str) -> bool {
    let result = path_finder_impl(maze);
    match result {
        Some(_) => true,
        None => false,
    }
...
fn path_finder_impl(maze: &str) -> Option<u32> {
    println!("maze: \n{}",maze);
...
#[cfg(test)]
mod tests {
    use super::path_finder_impl;


    #[test]
    fn fixed_tests() {
        assert_eq!(path_finder_impl("."), Some(0), "\nYour answer (left) is not the expected answer (right).");
        assert_eq!(path_finder_impl(".W.\n.W.\n..."), Some(4), "\nYour answer (left) is not the expected answer (right).");
        assert_eq!(path_finder_impl(".W.\n.W.\nW.."), None, "\nYour answer (left) is not the expected answer (right).");
        assert_eq!(path_finder_impl("......\n......\n......\n......\n......\n......"), Some(10), "\nYour answer (left) is not the expected answer (right).");
        assert_eq!(path_finder_impl("......\n......\n......\n......\n.....W\n....W."), None, "\nYour answer (left) is not the expected answer (right).");
    }
